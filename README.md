...
**27 écrans · 94 états**, vérifiés sur 1 128 rendus (écran × état × connecté/visiteur × desktop/mobile × administrateur/agent). On valide ici les **parcours, la hiérarchie de l'information et les états**.

> **👤 Connecté en tant qu'agent (09/2026).** Le compte est celui de l'agence, mais on se connecte en tant que **personne** — administrateur ou agent — et la barre d'outils du proto bascule entre les trois (Admin · Jean-Marc / Agent · Sophie / Agent · Nadim). Ça change la nav (nom, rôle, plafond à côté du solde), le tableau de bord (mes biens, mes leads, mes crédits sur mon plafond), « Mes biens » et « Mes leads » (attribués à moi / toute l'agence, colonne référent), le catalogue (le plafond de la personne connectée), le succès de déblocage (qui débite), et le profil : l'agence entière pour l'administrateur, **« Mon compte »** pour un agent (mes crédits, mon registre, mes résultats, mon identité, mes notifications, ma sécurité — jamais la carte, les factures ni les plafonds des autres). Chaque bien a un **négociateur référent** (choisi au dépôt, reçoit les leads du bien). Nouvel écran **« Inviter un collaborateur »** : l'administrateur invite avec rôle, plafond mensuel et biens attribués ; l'agent reçoit l'email, crée son propre mot de passe et vérifie son mobile par SMS — l'agence est vérifiée une fois, la personne se vérifie elle-même.
