...
- **Le suivi de demande n'affiche que ce qu'on sait.** On sait que la demande est partie et que l'agence l'a ouverte. On ne sait pas si elle a appelé. D'où trois statuts seulement — `Envoyée` · `Consultée` · `Sans nouvelle` — et un bouton « l'agence m'a répondu », seule façon honnête de fermer la boucle.
- **La bascule à 48 h.** Sans réponse, on propose un autre mandataire du même bien. C'est la valeur du regroupement rendue tangible au moment exact où l'utilisateur en a besoin.
